...
//
// Related Topics 哈希表 链表 双指针 👍 2754 👎 0
...
public class IntersectionOfTwoLinkedLists {
    public static void main(String[] args) {
        ...
        ListNode headA = ListNode.of(4, 1).append(common);
        ListNode headB = ListNode.of(5, 6, 1).append(common);

        // 调用方法
        ListNode intersection = solution.getIntersectionNode(headA, headB);
        log.info("相交的起始节点值为：{}", intersection.val);

...
def execute_sqlite(db_path: str, sql: str, params: Union[Sequence[Any], Dict[str, Any]], max_rows: int) -> Tuple[
    List[str], List[Tuple[Any, ...]]]:
...
def execute_sqlalchemy(dsn: str, sql: str, params: Union[Sequence[Any], Dict[str, Any]], max_rows: int) -> Tuple[
    List[str], List[Tuple[Any, ...]]]:
    try:
